...
const debug = require('debug')('render-handlebars');
...
function renderTemplates(options)
{
    ...
    return pluginKit.middleware({
        ...
        each: (competitionName, competition, files, metalsmith) => {
                ...
                // TODO remove competition from files, rename competition, re-add to files with new name
                if (options.renderedExtension) {
                    ...
                    debug('renaming %s to %s', competitionName, newName);
