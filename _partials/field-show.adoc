...
{{#if anthem_performer}}And now, I ask you to please rise, remove your caps, and enjoy our National Anthem, performed by {{anthem_performer}}.{{/if}}
...
You all make our Band Review happen!

<<<

== Field Show - Awards

{{#unless fieldshow.sponsors.general}}NOTE: There are no field show sponsors.
{{/unless}}
{{#unless fieldshow.sponsors.trophies}}NOTE: There are no field show sponsors.
{{/unless}}
